...
@Component({
  ...
  templateUrl: './form-reporte-averia.component.html',
  styleUrls: ['./form-reporte-averia.component.css']
})
export class FormReporteAveriaComponent implements OnInit {

  tipoFuga!:string|null;
  ...
  ngOnInit(): void {
    this.tipoFuga = this.route.snapshot.paramMap.get('type');
  }
  ...
  getImgSource(){
    return `../../../assets/img/${this.tipoFuga}.svg`;
  }
