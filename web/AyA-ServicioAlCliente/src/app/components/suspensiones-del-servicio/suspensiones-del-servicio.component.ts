...
@Component({
  ...
  templateUrl: './suspensiones-del-servicio.component.html',
  styleUrls: ['./suspensiones-del-servicio.component.css']
})
export class SuspensionesDelServicioComponent implements OnInit {
